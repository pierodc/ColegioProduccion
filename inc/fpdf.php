...
function EAN13($x, $y, $barcode, $h=16, $w=.30)
{
...
// por PIERO
function XYcell($x,$y,$w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link=''){
	$this->SetXY($x,$y);
	$this->Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='');
	}
// FIN por PIERO
