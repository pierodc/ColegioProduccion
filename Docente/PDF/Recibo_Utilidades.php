...
$add_sql .= " AND Cedula = '$MM_Username' ";
...
do {
	...
	if($MontoBase>0){
		$pdf->AddPage();
		$pdf->Image($_SERVER['DOCUMENT_ROOT'].'/img/solcolegio.jpg', 10,10,0,20);
		$pdf->Image($_SERVER['DOCUMENT_ROOT'].'/img/NombreCol.jpg' , 30,10,0,12);
		...
		$Concepto .= ' '.DDMMAAAA($row_RS_Empleados['FechaIngreso']).' - Diciembre '.$Ano1.') ('.$AnosLaborados.' año)'; }
		else
		$Concepto .= ' correspondientes al año '.$Ano1.'.';
