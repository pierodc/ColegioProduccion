...
$pdf->Cell(60 , 5 , $Alumno->Nombres() , $borde , 0 , 'L'); 
$pdf->Ln(); 

$pdf->Cell(46 , 5 , $Alumno->Apellidos() , $borde , 0 , 'L'); 
$pdf->Ln();
...
$pdf->Image($Alumno->Foto("p"), $x0+46+50, $y0+0, 0, 30);
$pdf->Image($Alumno->Foto("m"), $x0+46+50, $y0+30, 0, 30);

$pdf->SetFont('Arial','B',12);

$pdf->SetXY($x0+46+50+35,$y0+5);
$pdf->Cell(60 , 5 , $Alumno->RepreNombres("p") , $borde , 0 , 'L'); 
$pdf->SetXY($x0+46+50+35,$y0+10);
$pdf->Cell(60 , 5 , $Alumno->RepreCedula("p") , $borde , 0 , 'L'); 

$pdf->SetXY($x0+46+50+35,$y0+35);
$pdf->Cell(60 , 5 , $Alumno->RepreNombres("m") , $borde , 0 , 'L'); 
$pdf->SetXY($x0+46+50+35,$y0+40);
$pdf->Cell(60 , 5 , $Alumno->RepreCedula("m") , $borde , 0 , 'L'); 
