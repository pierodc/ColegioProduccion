...
?>Fecha</td>
 ...
 <?php do { // RECIBOS ?>
             <tr>
              <td colspan="7" bgcolor="#0033FF"><img src="../../../img/b.gif" width="1" height="1" /></td>
            </tr>
			<tr >
              <?php //if ($Par) {$In = "In"; $Par=false;}else{$In = ""; $Par=true;} ?>
              <td colspan="2" class="Listado<?php echo $In; ?>Par"><b><?php echo DDMMAAAA($row_Recibos['Fecha'])." (" . $row_Recibos['Por'] . ")"; ?></b></td>
              ...
              <td colspan="4" align="center" nowrap="nowrap" class="Listado<?php echo $In; ?>Par"><b>
				...
				if (( $row_Recibos['NumeroFactura']==0 or $NumeroFactura==$NumFacMax ) and $Fac_Rif > "" or true){ 
...
<?php do { // Hijos del Recibo ?>
	...
	?> </td>
              ...
              <td align="right" class="Listado<?php echo $In; ?>Par"><b>
                <?php if($row_Recibos_Hijos['MontoHaber']>0) {echo Fnum($row_Recibos_Hijos['MontoHaber']);} ?>
              </b></td>
              <td align="right" class="Listado<?php echo $In; ?>Par"><b>
