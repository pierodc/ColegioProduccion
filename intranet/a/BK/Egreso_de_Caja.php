...
$query_RS_Recibos = sprintf("
SELECT * FROM ContableMov 
WHERE Descripcion = 'Egreso'  
AND Fecha = %s  
ORDER BY FechaIngreso ", GetSQLValueString($Fecha_RS_Recibos, "date"));
...
?>
    <tr >
            ...
            <td class="TituloLeftWindow">Concepto</td>
              <td class="TituloLeftWindow">Efectivo</td>
  ...
  <tr <?php $sw = ListaFondo($sw,$Verde);?>>  
    <td align="center" nowrap="nowrap" >&nbsp;<?php echo DDMMAAAA($Fecha); ?></td>
            ...
            <td align="right" nowrap="nowrap" >&nbsp;<?php echo $Tipo==4?Fnum($MontoDebe):""; 
	  if($Tipo==4){
		$Cant_Efec=$Cant_Efec+$MontoDebe;
	  }?></td>
    ...
    <?php  } while ($row_RS_Recibos = mysql_fetch_assoc($RS_Recibos));  ?>
            <tr>
              ...
              <td align="right" nowrap="nowrap" bgcolor="#FFFFFF"><strong><?php echo Fnum($Cant_Efec); ?></strong></td>
              <td nowrap="nowrap">&nbsp;</td>
              <td nowrap="nowrap">&nbsp;</td>
            ...
            <tr>
              ...
              <td nowrap="nowrap" class="TituloLeftWindow">Monto</td>
...
$row_RS_ = mysql_fetch_assoc($RS_);
	do {
		...
		echo '<option value="'.$Codigo.'">'.$Nombre.'</option>';
              ...
              <td nowrap="nowrap" class="FondoCampo"><input name="Observaciones" type="text" id="Observaciones" size="25" /></td>
            ...
            <tr valign="baseline">
              ...
              <td colspan="5"><input type="submit" value="Guardar" onclick="this.disabled=true;this.form.submit();" /></td>
            </tr>
            <tr valign="baseline">
