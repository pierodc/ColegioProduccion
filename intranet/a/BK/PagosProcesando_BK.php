...
<td colspan="5" class="subtitle">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
      <tr>
        <td class="subtitle" align="left">Pagos Procesando</td>
        <td class="subtitle" align="right"><a href="Recibo_Crea_Cliente.php?CodigoAlumno=<?php echo $CodigoAlumno ?>&amp;CodigoPropietario=<?php echo $_GET['CodigoPropietario'] ?>">crea Nombre</a><img src="../../img/b.gif" width="1" height="5" /><a href="Estado_de_Cuenta_Alumno.php?CodigoPropietario=<?php echo $_GET['CodigoPropietario']; ?>" id="ActualizaPagosXX"><img src="http://www.colegiosanfrancisco.com/img/Reload.png" width="31" height="27" border="0" align="absmiddle"  /></a></td>
      </tr>
    </tbody>
  </table></td>
</tr>
...
if($row_RS_ContableMov_Procesando['Tipo'] == 1 or $row_RS_ContableMov_Procesando['Tipo'] == 2){
	if( $row_RS_ContableMov_Procesando['CodigoCuenta'] == 1)  echo " Mercantil ";  
	elseif( $row_RS_ContableMov_Procesando['CodigoCuenta'] == 2) echo " Provincial ";
	else echo "<b> SELECCIONAR BANCO </b>";}  
 ?>&nbsp;</td>
                  </tr>
              <tr>
