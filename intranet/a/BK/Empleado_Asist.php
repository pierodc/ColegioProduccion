...
<table width="1000" border="0" align="center">
  ...
  <tr>
    <td width="25%" nowrap="nowrap"><a href="Empleado_Edita.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>"> <img src="../../i/client_account_template.png" width="32" height="32" border="0" align="absmiddle" /> Ficha</a></td>
    <td width="25%" nowrap="nowrap"><a href="Empleado_Asist.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>"><img src="../../i/calendar_edit.png" width="32" height="32" border="0" align="absmiddle" />Asistencia</a></td>
    <td width="25%" nowrap="nowrap"><a href="Empleado_Fidei.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>"><img src="../../i/sallary_deferrais.png" width="32" height="32" border="0" align="absmiddle" /> Fideicomiso</a></td>
    <td width="25%" nowrap="nowrap"><a href="Empleado_PagoDeduc.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>"><img src="../../i/coins_in_hand.png" width="32" height="32" border="0" align="absmiddle" /> Pagos Deducciones</a></td>
  </tr>
</table>
<p>
  <?php 
...
<p>&nbsp;</p>
  ...
  <tr class="subtitle">
    ...
    <td align="right"><?php 
	if($SW_Asistencia){ ?>
      <a href="Empleado_Asist.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>&SWasist=off">on</a><?php }else{?>
      <a href="Empleado_Asist.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>&SWasist=on">off</a><?php } ?></td>
  </tr>
  <tr>
    <td colspan="5">&nbsp;
...
<?php do{ ?><tr <?php $sw = ListaFondo($sw,''); ?>>
    ...
    <td><a href="Empleado_Asist.php?CodigoEmpleado=<?php echo $_GET['CodigoEmpleado'] ?>&delete=Cal&Codigo=<?php echo $row['Codigo'] ?>"><img src="../../i/bullet_delete.png" alt="" width="16" height="16" border="0" /></a></td>
</tr>
