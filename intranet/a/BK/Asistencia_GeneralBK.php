...
<div id="Login_div_<?php echo $Ln."_".$Dia ?>">
<form name="formulario" id="f1_<?php echo $Ln."_".$Dia ?>">

    <input name="texto" type="text" id="texto" value="" size="5"><br>
...
$(document).ready(function() {
	$("#Salir").on("click",function(e){
	    e.preventDefault();
		$("#Login_div").load("<?php echo $ToRoot ?>Login_jq.php?LogOut=1");
	});
...
<?php for ($Ln = 1; $Ln <= $LnMax; $Ln++) { 
		for ($Dia = 1; $Dia <= $DiasDelMes; $Dia++) { ?>
	
	$("#f1_<?php echo $Ln."_".$Dia ?>").on("submit", function(e){
		e.preventDefault();
		$.post("<?php echo $ToRoot ?>ok.php?cod=_<?php echo $Ln."_".$Dia ?>", $("#f1_<?php echo $Ln."_".$Dia ?>").serialize(), function(respuesta){
			$("#Login_div_<?php echo $Ln."_".$Dia ?>").html(respuesta);
		});	
	});
