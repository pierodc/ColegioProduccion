...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" valign="top"><table width="300" border="0">
        <tr>
...
while ($row = $RS->fetch_assoc()) {
	...
	$CodigoPropietario = CodigoPropietario($CodigoAlumno);
?>
<tr <?php $sw=ListaFondo($sw,$Verde); ?>>
  <td><a href="Estado_de_Cuenta_Alumno.php?CodigoPropietario=<?php echo $CodigoPropietario; ?>" target="_blank">&nbsp;<?php echo $CodigoAlumno; ?></a></td>
  <td>&nbsp;<?php echo Curso($CodigoCurso); ?></td>
  <td>&nbsp;<?php 
  
		$sql2 = "SELECT * FROM AlumnoXCurso
				WHERE Ano = '2016-2017'
				AND CodigoAlumno = '$CodigoAlumno'";
		$RS2 = $mysqli->query($sql2);
		$row2 = $RS2->fetch_assoc();
  		
		echo Curso($row2['CodigoCurso']);
