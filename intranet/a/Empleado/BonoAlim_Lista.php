<?php 
$MM_authorizedUsers = "91,secreAcad,AsistDireccion";
...
$DiasSemana =  GetSQLValueString(isset($_POST['SW_Lun']) ? "true" : "", "defined","1","").
  ...
  $updateSQL = sprintf("UPDATE Empleado SET BonifAdicCT=%s, MontoCestaT=%s, DiasInasistencia=%s, ObservacionesCestaT=%s, SW_Lun=%s, SW_Mar=%s, SW_Mie=%s, SW_Jue=%s, SW_Vie=%s, SW_Sab=%s, SW_Dom=%s, DiasSemana='$DiasSemana', MontoCestaT_extra=%s WHERE CodigoEmpleado=%s",
                       ...
                       GetSQLValueString(coma_punto($_POST['MontoCestaT_extra']), "double"),
...
<table width="1000" border="0" align="center">
  ...
  <tr>
    <td colspan="2" align="center"><table width="100%" border="0" cellpadding="2">
        <tr>
          <td colspan="2" nowrap="nowrap" class="NombreCampoTopeWin"><a href="BonoAlim_Lista.php">Ver todos</a> | <a href="PDF/Nomina_BonoAlim.php?AnoMes=<?php echo date('Y-m') ?>" target="_blank">N&oacute;mina Bono Alim</a> | <a href="archivo/BonoAlim/Bono_<?php echo date('Y_m') ?>.csv">Archivo Bono Alim</a>| <a href="PDF/Asistencia_General.php?Inicio=2012-<?php echo date('m'); ?>">Asistencia
          </a><br />
          <a href="PDF/Ficha_Empleado2.php">Lista pdf</a></td>
        </tr>
        <tr>
...
<input type="submit" name="button" id="button" value="Buscar" />
          ...
          <a href="BonoAlim_Lista.php?Limit=<?php echo '0'; ?>">Primero</a> | 
          <a href="BonoAlim_Lista.php?Limit=<?php if($_GET['Limit']>10) echo $_GET['Limit']-10; else echo '0'; ?>">Anterior</a> |
          ...
          <a href="BonoAlim_Lista.php?Limit=<?php echo $k*25;  ?>"><?php echo $k*25; ?></a> |  
          
          <?php }
		  $k++;
		  }while($k*25 <= 100); ?>
          
          <a href="BonoAlim_Lista.php?Limit=<?php  echo $_GET['Limit']+25; ?>">Siguiente</a> | 
          <a href="BonoAlim_Lista.php?Limit=<?php  echo $totalRows_RS_Empleados-25; ?>">Ultimo</a></td>
        </tr>
        <tr>
...
<form action="<?php echo $editFormAction; ?>?Limit=<?php echo $Limit-1; ?>&Linea=1" method="post" name="form1" id="form1">
  <table width="100%" border="1" cellpadding="1" cellspacing="0">
    <tr>
  <td width="5" rowspan="4" align="center" valign="top"><img src="../../FotoEmp/<?php echo $Emp[$i][CodigoEmpleado]; ?>.jpg" alt="" width="83" height="124" /></td>
  <td width="59" nowrap="nowrap" >&nbsp;</td>
  <td width="59" nowrap="nowrap" bgcolor="<?php if (!(strcmp($Emp[$i][SW_activo],"1"))) {echo "#33CC00";} else {echo "#CC3300";} ?>" >&nbsp;</td>
<td nowrap="nowrap" ><strong>
  <a href="Ficha_Datos.php?CodigoEmpleado=<?php echo $Emp[$i][CodigoEmpleado]; ?>" target="_blank">
...
<td width="80" rowspan="6" align="left" valign="bottom" nowrap="nowrap"><br />
...
?>
  ...
  <tr>
    ...
    <td align="left" nowrap="nowrap">por d&iacute;a<span class="FondoCampo">(base <?php echo round($UnidadTributaria * $PorcentajeCestaTiket /100 , 2) ?>)</span>:
<input name="MontoCestaT" type="text" id="MontoCestaT" value="<?php echo $Emp[$i][MontoCestaT]; ?>" size="10" />
      Inas:      
      <input name="DiasInasistencia" type="text" id="DiasInasistencia" value="<?php echo $Emp[$i][DiasInasistencia]; ?>" size="5" />
      Obser.:      
      <input name="ObservacionesCestaT" type="text" id="ObservacionesCestaT" value="<?php echo $Emp[$i][ObservacionesCestaT]; ?>" size="10" />
      Adic: 
      <input name="BonifAdicCT" type="text" id="BonifAdicCT" value="<?php echo $Emp[$i][BonifAdicCT]; ?>" size="10" />
  ...
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left">Extrra:</td>
    <td align="left"><label for="MontoCestaT_extra"></label>
      <input type="text" name="MontoCestaT_extra" id="MontoCestaT_extra" value="<?php echo $Emp[$i][MontoCestaT_extra]; ?>"  /></td>
    </tr>
  <tr>
    <td align="left">&nbsp;</td>
...
Campo('DiasSemana' , 'h' , $Emp[$i][DiasSemana] , 6,''); 
  ...
  ?>
      <table border="1" cellspacing="0">
        <tr>
          <td width="40" align="center"><input name="SW_Lun" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Lun]?'checked="checked"':''; ?> />
            <br />
            Lu</td>
          <td width="40" align="center"><input name="SW_Mar" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Mar]?'checked="checked"':''; ?> />
            <br />
            Ma</td>
          <td width="40" align="center"><input name="SW_Mie" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Mie]?'checked="checked"':''; ?> />
            <br />
            Mi</td>
          <td width="40" align="center"><input name="SW_Jue" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Jue]?'checked="checked"':''; ?> />
            <br />
            Ju</td>
          <td width="40" align="center"><input name="SW_Vie" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Vie]?'checked="checked"':''; ?> />
            <br />
            Vi</td>
          <td width="40" align="center"><input name="SW_Sab" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Sab]?'checked="checked"':''; ?> />
            <br />
            Sa</td>
          <td width="40" align="center"><input name="SW_Dom" type="checkbox" id="checkbox" <?php echo $Emp[$i][SW_Dom]?'checked="checked"':''; ?> />
            <br />
            Do</td>
          <td>&nbsp;
