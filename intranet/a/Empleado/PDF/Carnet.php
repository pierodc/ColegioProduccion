...
$foto = $_SERVER['DOCUMENT_ROOT'] . "/f/FotoEmp/150/".$CodigoEmpleado.".jpg";
...
$pdf->Image('../../../../img/solcolegio.jpg', 10, 16, 52);
$pdf->Ln(1); 
...
$pdf->Image('../../../../img/Firma_Direc.jpg', 10, 65, 15);
...
$pdf->SetFont('Arial','',8);
$pdf->Cell(54 , 3 , $CedulaLetra.' '.$Cedula , $borde , 1 , 'C' ); 
$pdf->Cell(54 , 3 , $CargoLargo , $borde , 1 , 'C' ); 
...
$pdf->Cell(20, 3 , 'La Directora' , $borde , 0 , 'C');
$pdf->SetFont('Arial','',8);
$pdf->Cell(33 , 3 , 'Tel.Clg:0212.283.25.75' , $borde , 0 , 'R'); 
//$pdf->SetFont('Arial','',8);
...
$pdf->EAN13(22,74,$CodigoBarras,10);
