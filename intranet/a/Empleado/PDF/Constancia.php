...
$pdf->MultiCell(170 , $Ln , "     Quien suscribe, $ConstaciaFirmaNombre, portadora de la cédula de identidad No. $ConstaciaFirmaCedula, en su carácter de $ConstaciaFirmaCargo del Colegio San Francisco de Asís c.a., RIF J-00137023-4; por medio de la presente hace constar que el(la) ciudadano(a):" , $borde , 'J'); 
	 
$pdf->Ln($Ln);
	 
$NombreCompleto = $Nombres." ".$Nombre2." ".$Apellidos." ".$Apellido2;
$pdf->SetFont('Times','B',16);
$pdf->Cell(170 , $Ln , $NombreCompleto , $borde , 1 , 'C'); 
$pdf->Ln($Ln);

$pdf->SetFont('Times','',14);
$pdf->MultiCell(170 , $Ln , "      Portador(a) de la cédula de identidad No.".$CedulaLetra.'-'.Fnum_dec($Cedula) ." presta sus servicios en esta empresa como:", $borde , 'J'); 
...
$pdf->SetFont('Times','',14);
$pdf->MultiCell(170 , $Ln , "  Fecha de Ingreso: ".DDMMAAAA($FechaIngreso) , $borde , 'J');  
$pdf->MultiCell(170 , $Ln , "  Sueldo Mensual actual Bs.: ".Fnum($SueldoBase*2) , $borde , 'J');  
$pdf->MultiCell(170 , $Ln , "  Beneficios de Ley " , $borde , 'J');  
...
$pdf->Ln($Ln*3);
$pdf->Cell(170 , $Ln , $ConstaciaFirmaNombre , $borde , 1 , 'C'); 
$pdf->Cell(170 , $Ln , $ConstaciaFirmaCargo , $borde , 1 , 'C'); 
