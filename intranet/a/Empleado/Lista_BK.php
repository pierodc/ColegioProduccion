...
<div class="row">
	...
	<?php echo $row_RS_Empleados[Apellidos] ." ". $row_RS_Empleados[Apellido2] .", ". $row_RS_Empleados[Nombres] ." ". $row_RS_Empleados[Nombre2]; ?></a>
...
<tr>
      <td colspan="3" align="left"  nowrap><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td  class="NombreCampoBIG"><?php echo ++$i ?>) <a href="Ficha_Datos.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado]; ?>" target="_blank" ><?php echo $row_RS_Empleados[Apellidos]; ?> <?php echo $row_RS_Empleados[Apellido2]; ?>, <?php echo $row_RS_Empleados[Nombres]; ?> <?php echo $row_RS_Empleados[Nombre2]; ?></a></td>
            <td align="right"  class="NombreCampoBIG"><form name="form" id="form"><select name="jumpMenu2" id="jumpMenu2" onchange="MM_jumpMenu('parent',this,0)">
...
while ($row = $RS->fetch_assoc()) {
	//extract($row);
	?>  
	<option value="../Configuracion/Contrato_pdf.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado]; ?>&Codigo=<?php echo $row["Codigo"] ?>" <?php 
  ...
  ?></select></form></td>
            <td width="100" align="right"  class="NombreCampoBIG"><?php 
			...
			?>
              ...
              |
               <a href="Ficha_PagoDeduc.php?BC=1&CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado]; ?>" target="_blank" >BC</a>
...
<tr>
  <td align="center" valign="top" <?php echo $class ?>><img src="../../../i/b.png" width="150" height="1" alt=""/><br><a name="<?php echo $i ?>" id="Linea2"></a>
    <?php if ($Dsp['Foto']) { 
  ...
  <td width="100%"  valign="top" nowrap="nowrap" <?php echo $class ?>><table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr><td><iframe src="iFr_ListaEmpleado.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado] ?>" width="100%" height="300" frameborder="0" seamless="seamless"></iframe></td></tr>    
  <?php //}
 ?>  
    
  </table></td>
  <td width="131" rowspan="2" align="left" valign="top" nowrap="nowrap" <?php echo $class ?>><table width="100%" border="0">
<?php if(TieneAcceso($Acceso_US,"Sueldo")) { ?>  
    <tr>
          <td align="right" nowrap="nowrap"><a href="PDF/Recibo_Pago.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado]; ?>&amp;Quincena=<?php if(date('d')<=15) echo '1ra'; else echo '2da'; ?>" target="_blank">Recibo N&oacute;m</a><br />
            ...
            <a href="ListaRetroactivo.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado] ?>" target="_blank">Retroactivo</a><br /></td>
        </tr>
<?php } ?>        
    <tr>
      <td align="right"><a href="PDF/Carnet.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado] ?>" target="_blank">Carnet</a>
        <?php 
Frame_SW ($ClaveCampo,$ClaveValor,$Tabla,'SW_Carnet_Emitir',$row_RS_Empleados[SW_Carnet_Emitir]);
?>
        <br />
        <?php Campo('CodigoEmpleado' , 'h' , $row_RS_Empleados[CodigoEmpleado] , 6,''); ?></td>
    </tr>
        <tr>
          <td align="right"><a href="../Contabilidad/Gastos.php?Rif=<?php echo $row_RS_Empleados[Cedula] ?>&Nombre=<?php echo $row_RS_Empleados[Apellidos].' '.$row_RS_Empleados[Nombres] ?>" target="_blank">Recibo Particular</a></td>
        </tr>
        <tr>
          <td align="right"><a href="PDF/Constancia.php?CodigoEmpleado=<?php echo $row_RS_Empleados[CodigoEmpleado] ?>" target="_blank">Cosntancia Trab</a></td>
        </tr>
  </table>
      </p></td>
</tr>
