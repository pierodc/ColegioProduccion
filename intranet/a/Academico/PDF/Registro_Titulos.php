...
$AlumnosPag[1] = min(25,$TotalAlumnos);
$TotalAlumnos = $TotalAlumnos - 25;
...
while ($row = $RS->fetch_assoc()) {
	...
	if($No == 1){
		...
		// Encabezado Página
		$pdf->Image('../../../../img/LogoME_ResFinal.jpg', 10, 5, 90, 0);
		...
		$NombrePlanDeEstudio = 'BACHILLER';//.$row_mat['NombrePlanDeEstudio'];
