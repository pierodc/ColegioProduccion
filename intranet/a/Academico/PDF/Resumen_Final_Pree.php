...
$pdf->SetY( 5 );
$pdf->Ln($Ln);
$pdf->Cell(115); $pdf->Cell(70  , $Ln , 'MATRÍCULA FINAL EDUCACIÓN INICIAL' , 'B' , 0 , 'C');
$pdf->Ln($Ln);
...
/*$pdf->Cell(60);  $pdf->Cell(33  , $Ln , 'Plan de Estudio: ' , 0 , 0 , 'L');
				 $pdf->Cell(65  , $Ln , ' '.$row_mat['NombrePlanDeEstudio'].'          Código: '.$row_mat['CodigoPlanDeEstudio']  , 'B' , 0 , 'L');
...
$pdf->Cell(60);  $pdf->Cell(30  , $Ln , 'I.   Año Escolar: ' , 0 , 0 , 'L');
				 ...
				 $pdf->Cell(56  , $Ln , '  Mes y Año Matrícula Final:' , 0 , 0 , 'L');
...
$pdf->Cell(50  , $Ln , 'III.    Identificación del Curso:' , 0 , 0 , 'L');
$pdf->Ln($Ln);

$pdf->Cell(23  , $Ln , 'Grado o Año: ' , 0 , 0 , 'L');
$pdf->Cell(20  , $Ln , '  '.$row_mat['Curso'] , 'B' , 0 , 'L');
$pdf->Cell(16  , $Ln , ' Sección: ' , 0 , 0 , 'L');
$pdf->Cell(8   , $Ln , '  '.$row_mat['Seccion'] , 'B' , 0 , 'L');
$pdf->Cell(55  , $Ln , ' No. de Alumnos de la Sección: ' , 0 , 0 , 'L');
$pdf->Cell(14  , $Ln , ' '.$num_Alum_Seccion , 'B' , 0 , 'L');
$pdf->Cell(55  , $Ln , ' No. de Alumnos en esta Pág.: ' , 0 , 0 , 'L');
$pdf->Cell(14  , $Ln , '  '.$totalRows_RS_Alumnos , 'B' , 0 , 'L');
$pdf->Ln($Ln);



$pdf->Cell(100  , $Ln , 'IV.   Matrícula Final del Rendimiento: ' , 0 , 0 , 'L');
$pdf->Ln($Ln);
$Ln = 4.4;
	...
	// Linea 2
	$pdf->Cell(7  , $Ln  ,''  , 0 , 0 , 'C'); 
	$pdf->Cell(38.5 , $Ln , 'Cédula de Identidad' , '' , 0 , 'C'); 
	...
	// Linea 3
	$pdf->Cell(7  , $Ln  ,''  , 0 , 0 , 'C'); 
	$pdf->Cell(38.5  , $Ln  ,'o Cédula Escolar'  , '' , 0 , 'C'); 
	$pdf->Cell(94.7  , $Ln  ,''  , 0 , 0 , 'C'); 
