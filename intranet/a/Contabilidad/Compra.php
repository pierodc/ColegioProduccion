...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center" valign="top"><table width="90%" border="0">
        <tr>
          <td colspan="2" class="NombreCampoTITULO">Titulo</td>
        </tr>
<?php 
//$RS = $mysqli->query($query_RS_Alumno);
//while ($row = $RS->fetch_assoc()) {
...
foreach (array("id_Rif"=>"","FacturaNumero"=>"","ControlNumero"=>"","Fecha"=>"","Base_Imponible"=>"","Base_Excenta"=>"","IVA_porciento"=>"16") as $Clave => $Valor)	{
?>

<tr <?php $sw=ListaFondo($sw,$Verde); ?>>
  <td class="NombreCampo">&nbsp;<?= $Clave ?></td>
  <td class="FondoCampo">
    <input type="text" name="<?= $Clave ?>" id="<?= $Clave ?>" value="<?= $Valor ?>" /></td>
  </tr>
<?php 	
  }
	//}
?>
<tr <?php $sw=ListaFondo($sw,$Verde); ?>>
  <td colspan="2" align="center" class="NombreCampo"><input type="submit" name="submit" id="submit" value="Submit" /></td>
  </tr>
    </table>&nbsp;</td>
  </tr>
  <tr>
