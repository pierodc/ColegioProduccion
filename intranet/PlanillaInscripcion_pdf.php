...
$query = "UPDATE AlumnoXCurso SET 
			...
			WHERE CodigoAlumno = '$CodigoAlumno'
			AND Ano = '".$AnoEscolarProx."'";
mysql_query($query, $bd) or die(mysql_error());
...
$pdf->RotatedText(160,18,'Actualizó: '.DDMMAAAA($row_RS_Alumno['Datos_Revisado_Fecha']),10);
//$pdf->AddPage();
...
if($totalrow_RS_Autorizado>0){
	...
	} while ($row_RS_Autorizado = mysql_fetch_assoc($RS_Autorizado));
}
