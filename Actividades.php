<?php require_once('inc_login_ck.php'); ?><html>
<head>
...
<?php include('inc_menu.php'); ?>            </td>
            <td rowspan="3" align="center" class="box1"><p class="Tit_Pagina">Actividades y servicios</p>
            <p align="left">-Ingl&eacute;s (todos los niveles)  <br>
              -Italiano  <br>
              -Educaci&oacute;n F&iacute;sica (Voleiball, Basketball, Baseball, Football, etc.)  <br>
              -Preparaci&oacute;n para la Primera Comuni&oacute;n  <br>
              -Religi&oacute;n  <br>
              -Teatro  <br>
              -Computaci&oacute;n  <br>
              -Torneos deportivos intercurso  <br>
              -Pintura (*)<br> 
              -F&uacute;tbol (*)  <br>
              -K&aacute;rate (*)  <br>
              -Jazz (*)<br>  
              ...
              <br>
              Otros Servicios: <br>
              -Atenci&oacute;n Psicol&oacute;gica  <br>
              -Notas Computarizadas  <br>
              -Seguro Escolar  <br>
              -Rescarvencito (*)  <br>
              -T&eacute;cnicas de Estudio (*)  <br>
              -Tareas Dirigidas (para todos los niveles) (*)  <br>
              -Almuerzo (*)  <br>
              -Transporte (tres horarios a varias zonas de Caracas) (*)  <br>
              <br>
            (*) Optativo</p>            </td>
            <td width="31" bgcolor="#FFF8E8">&nbsp;</td>
          </tr>
